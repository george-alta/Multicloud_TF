# all db resources have been commented out to avoid creating a db instance
...
#   storage_type       = "gp2"
#   db_name            = "wordpressdb" # not for production use, use a more secure name
#   username           = "admin" 
#   password           = "myLind0Pas23rsword" # not for production use, use a more secure password
